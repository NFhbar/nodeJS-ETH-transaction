 ...
 */
function txBuilder({method, fromAddress, toAddress, nonce, functionSignature, value, gasLimit, gasPrice, privateKey}) {

  //parameters in common
  //get the private key from .env
  var privateKey = new Buffer(process.env[privateKey], "hex");
  //values to hex
